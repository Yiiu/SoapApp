...
class ChineseCupertinoLocalizations implements CupertinoLocalizations {
  ...
  @override
  String get modalBarrierDismissLabel => "localizations.dart -> Dismiss";

  @override
  String tabSemanticsLabel({int? tabIndex, int? tabCount}) {
    return "localizations.dart -> semantics";
  }
  ...
  @override
  List<String> get timerPickerHourLabels => ['timerPickerHourLabels'];

  @override
  List<String> get timerPickerMinuteLabels => ['timerPickerMinuteLabels'];
